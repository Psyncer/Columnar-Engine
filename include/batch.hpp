...
public:
    Batch(const Schema& schema, size_t capacity = 100'000);  // throws
...
private:
    ...
    static void parse_and_append(BatchColumn& column, const std::string& token, ParseFn parse_fn);  // throws
};
